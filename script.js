...
let songs = [
    {
        ...
        audioSrc: "music/consume.mp3",
        videoBgSrc: "video/consume.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics: [
            { time: 0.1, text: "本当は私気づいてたんです" },
            { time: 4, text: "あなたが私を見ていてくれたこと" },
            { time: 13, text: "Alright, alright, whoa" },
            { time: 16, text: "Why you pointing at me with that knife?" },
            { time: 19, text: "I've been cutting corners all my life, girl" },
            { time: 22, text: "The terror doesn't blossom overnight, no" },
            { time: 27, text: "She's running through the city in a rampage" },
            { time: 30, text: "Pressing on her fingers 'til the bones break" },
            { time: 33, text: "There's blood all in her nose from the propane" },
            { time: 36, text: "But a needle to the skin will make the pain fade" },
            { time: 39, text: "Yeah, ah-ah" },
            { time: 41, text: "This is what I do, ah-ah" },
            { time: 45, text: "Take another bite, ah-ah" },
            { time: 48, text: "Big enough to chew" },
            { time: 53, text: "She said, ''Careful, or you'll lose it''" },
            { time: 55.5, text: "But, girl, I'm only human" },
            { time: 59, text: "And I know there's a blade where your heart is" },
            { time: 63, text: "And you know how to use it" },
            { time: 66, text: "And you can take my flesh if you want, girl" },
            { time: 70, text: "But, baby, don't abuse it" },
            { time: 73, text: "These voices in my head screaming, ''Run, now''" },
            { time: 76, text: "I'm praying that they're human" },
            { time: 79, text: "Rollin', rollin', rolling back your eyes through your mind like" },
            { time: 85, text: "Oh, whoa, the pressure in the gland's tight" },
            { time: 91.8, text: "Yeah, whoa, yeah, it's either kill or be killed like" },
            { time: 98, text: "Oh, whoa, the blood is either poured or it's spilt like" },
            { time: 105, text: "Yeah, ah-ah" },
            { time: 107, text: "This is what I do, ah-ah" },
            { time: 110, text: "Take another bite, ah-ah" },
            { time: 114, text: "Big enough to chew" },
            { time: 118, text: "She said, ''Careful, or you'll lose it''" },
            { time: 121.5, text: "But, girl, I'm only human" },
            { time: 125, text: "And I know there's a blade where your heart is" },
            { time: 129, text: "And you know how to use it" },
            { time: 131, text: "And you can take my flesh if you want, girl" },
            { time: 135.8, text: "But, baby, don't abuse it" },
            ...
            { time: 150, text: "Nah, I've been alone almost all my life, girl" },
            { time: 153, text: "And shit like that don't change up overnight, sweet" },
            { time: 158, text: "I let you sleep in my tee (tee)" },
            { time: 161, text: "Tell me the things that you don't normally tweet" },
            { time: 163, text: "Acid and LSD and smokin' blunts on the beach" },
            { time: 166, text: "69 down 69, so we can both get a piece, yeah" },
            { time: 171, text: "I've been cutting corners like my whole life" },
            { time: 174, text: "Backstabbing bitches tryna kill me with the whole knife" },
            { time: 177, text: "Day I die'll be the only day a nigga ghostwrite" },
            { time: 180, text: "When I go, they'll treat me like a god if this shit goes right" },
            { time: 184, text: "She said, ''Careful, or you'll lose it''" },
            { time: 187.5, text: "But, girl, I'm only human" },
            { time: 190, text: "And I know there's a blade where your heart is" },
            { time: 194, text: "And you know how to use it" },
            { time: 197, text: "And you can take my flesh if you want, girl" },
            { time: 200, text: "But, baby, don't abuse it" },
            { time: 204, text: "These voices in my head screaming, ''Run, now''" },
            { time: 207, text: "I'm praying that they're human" },
            { time: 211, text: "Please understand that I'm trying my hardest" },
            { time: 214, text: "My head's a mess, but I'm trying regardless" },
            { time: 218, text: "Anxiety is one hell of a problem" },
            { time: 221, text: "She's latching onto me, I can't resolve it" },
            { time: 224, text: "It's not right, it's not fair, it's not fair, it's not fair" },
            { time: 232, text: "It's no fair, it's no fair" },
            { time: 235, text: "Oh, no, no, no (ooh-ooh)" },
            { time: 245, text: "Don't run, don't run" }
        ]
    },
    {
        id: 2,
    ...
    },
    {
        ...
        videoBgSrc: "video/i_wanna_be_yours.mp4",
        lyrics: [
